    ...
    companion object {
        ...
        fun getSearchSuggestions(
            ...
            return ApiClient.getClient()!!.create(ApiDetails::class.java).getSearchSuggestions(
                AppSharedPref.getStoreId(context),
                AppSharedPref.getCurrencyCode(context), searchQuery
            )
        }
        ...
        fun getSearchTermsList(
            ...
            return ApiClient.getClient()!!.create(ApiDetails::class.java).getSearchTermsList(
                eTag, AppSharedPref.getCurrencyCode(context), AppSharedPref.getStoreId(context)
            )
        }
        ...
        fun addToCart(
            ...
            Log.d(
                "TAG", "addToCart----: " + AppSharedPref.getStoreId(context)
                        + "," + AppSharedPref.getCustomerToken(context)
                        + "," + AppSharedPref.getQuoteId(context)
                        + "," + productId
                        + "," + qty
        ...
        fun updateTokenOnCloud(
            ...
            return ApiClient.getClient()!!.create(ApiDetails::class.java).updateTokenOnCloud(
                BundleKeysHelper.BUNDLE_KEY_CHAT_IDENTIFIER_CUSTOMER + AppSharedPref.getCustomerId(
                    context
                ),
        ...
        fun getProducts(): Observable<List<ProductItem>> {
            val apiDetails = ApiClient.getClient()!! .create(ApiDetails::class.java)
            return apiDetails.getProducts()
        ...
        fun countryCodeApi(context: Context): Observable<CountryCodeListingResponseModel> {
            return ApiClient.getClient()!!.create(ApiDetails::class.java)
                .countryCodeApi(AppSharedPref.getStoreId(context))
        }
        ...
        fun getOrderTrackingData(context: Context, shipmentId: String): Observable<String> {
            return ApiClient.getClient()!!.create(ApiDetails::class.java)
                .getOrderTrackingData(shipmentId, AppSharedPref.getCustomerId(context))
        }
