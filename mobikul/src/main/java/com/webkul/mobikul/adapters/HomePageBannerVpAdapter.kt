...
import com.libraltraders.android.databinding.ItemHomeBannerViewPagerBinding
 ...
 */
class HomePageBannerVpAdapter(private val mContext: BaseActivity, private val mListData: ArrayList<BannerImage>) : PagerAdapter() {

    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        val itemViewPagerBannerBinding = DataBindingUtil.bind<ItemHomeBannerViewPagerBinding>(LayoutInflater.from(mContext).inflate(R.layout.item_home_banner_view_pager, container, false))
